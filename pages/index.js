...
export default function Home() {
  ...
  <>
        ...
        <div className="pt-12 sm:pt-16 lg:pt-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl lg:text-5xl">Get the Open Revolution Book</h2>
            </div>
          </div>
        </div>
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-lg mx-auto rounded-lg shadow-lg overflow-hidden lg:max-w-none lg:flex">
                <div className="flex-1 bg-white px-6 py-8 lg:p-12">
                  <h3 className="text-2xl font-extrabold text-gray-900 sm:text-3xl">Free and Open Version</h3>
                  <p className="mt-6 text-base text-gray-500">
                    In keeping with the philosophy of the book, The Open Revolution is available "openly" and you can download it directly for free. If you get value from it, please consider making <a href="/pay-what-feels-right/">a contribution back</a>.
                  </p>
                </div>
                <div className="py-8 px-6 text-center bg-gray-50 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12">
                  <p className="text-lg leading-6 font-medium text-gray-900">PDF</p>
                  ...
                  <div className="mt-4 text-sm">
                    <a href="/pay-what-feels-right/" className="font-medium text-gray-900">
                      Make a Donation
                    </a>
                  </div>
                </div>
                <div className="py-8 px-6 text-center bg-gray-50 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12">
                  <p className="text-lg leading-6 font-medium text-gray-900">ePUB</p>
                  <div className="mt-4 flex items-center justify-center text-5xl font-extrabold text-gray-900">
                    <span>$0</span>
                  </div>
                  <div className="mt-6">
        ...
        <div className="mt-8 bg-white pb-16 sm:mt-12">
          <div className="relative">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-lg mx-auto rounded-lg shadow-lg overflow-hidden lg:max-w-none lg:flex">
                <div className="flex-1 bg-white px-6 py-8 lg:p-12">
                  <h3 className="text-2xl font-extrabold text-gray-900 sm:text-3xl">Buy the Book</h3>
                  <p className="mt-6 text-base text-gray-500">
                    Buy the book on Amazon in paperback or digital form and support our work. Just choose the option and store that works for you.
                  </p>
                </div>
                <div className="py-8 px-6 text-center bg-gray-50 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12">
                  <p className="text-lg leading-6 font-medium text-gray-900">Paperback</p>
                  <div className="mt-4 flex items-center justify-center text-5xl font-extrabold text-gray-900">
                    <span>$9.99</span>
                  </div>
                  <div className="mt-6">
                ...
                <div className="py-8 px-6 text-center bg-gray-50 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12">
                  <p className="text-lg leading-6 font-medium text-gray-900">Kindle</p>
                  <div className="mt-4 flex items-center justify-center text-5xl font-extrabold text-gray-900">
                    <span>$6.99</span>
                  </div>
                  <div className="mt-6">
    ...
    <section className="relative pt-16 sm:pt-20" id="testimonials">
      <h1 className="text-3xl lg:text-5xl font-extrabold text-center pb-16">What People are Saying</h1>
    ...
    <section className="max-w-prose mx-auto prose pt-20">
      ...
      <p><strong>Dr Rufus Pollock</strong> is a researcher, technologist and entrepreneur. He has been a pioneer in the global Open Data movement, advising national governments, international organisations and industry on how to succeed in the digital world. He is the founder of Open Knowledge, a leading NGO with a presence in over 35 countries, empowering people and organizations with access to information so they can create insight and drive change. Formerly, he was the Mead Fellow in Economics at Emmanuel College, University of Cambridge. He has been the recipient of a $1m Shuttleworth Fellowship and is currently an Ashoka Fellow and Fellow of the RSA. He holds a PhD in Economics and a double first in Mathematics from the University of Cambridge.</p>

      <div className="w-full">
        <iframe src="https://www.youtube.com/embed/15L7i0201ms?autoplay=0&showinfo=0&controls=1" frameborder="0" width="100%" allowfullscreen></iframe>
      </div>
    </section>

    <section className="relative pt-16 sm:pt-24 lg:pt-32 prose max-w-prose mx-auto">
      <h1 className="text-4xl text-center">The Open Revolution in a Nutshell</h1>
      <h3>An open world, a world in which information is openly and freely available to us all</h3>
      <p>Will the digital revolution give us digital dictatorships or digital democracies? Forget everything you think you know about the digital age. It’s not about privacy, surveillance, AI or blockchain&mdash;it's about ownership. Because, in a digital age, who owns information controls the future.</p>
      <p>Today, information is everywhere. From your DNA to the latest blockbusters, from lifesaving drugs to the app on your phone, from big data to algorithms. Our entire global economy is built on it and the rules around information affect us all every day.</p>
      <p>As information continues to move into the digital domain, it can be copied and distributed with ease, making access and control even more important. But the rules we have made for it, derived from how we manage physical property, are hopelessly maladapted to the digital world.</p>
      <p>In this urgent and provocative book, Rufus Pollock shows that we must make a choice between making information Open, shared by all, or making it Closed, exclusively owned and controlled, and how today’s Closed digital economy is the source of problems ranging from growing inequality, to unaffordable medicines, to the power of a handful of tech monopolies to control how we think and vote.</p>
      <p>Choosing Open is the path to a more equitable, innovative and profitable future for all.</p>
      <p><Link href="/preview/"><a>Read more &raquo;</a></Link></p>

      <h2>Or Watch a Short Video</h2>
      <h3>A Robot Revolution for the 1%?</h3>
      <iframe width="560" height="315" src="https://www.youtube.com/embed/nPTgpyBb7oU?start=215" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

      <h3>The Hidden Cause of Growing Inequality - TEDx</h3>
      <iframe width="560" height="315" src="https://www.youtube.com/embed/6V6x7jySLvc?start=6" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </section>
